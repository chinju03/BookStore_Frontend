                    ...
                    {!token ?
                        ...
                        <div className='relative inline-block text-left  '>
                            <button onClick={() => setDropdownStatus(!dropdownStatus)} className='w-full flex items-center px-3 py-2 shadow-lg hover:bg-gray-100 bg-white'>
                                ...
                                <img src={userProfile == "" ? "https://media.istockphoto.com/id/1130884625/vector/user-member-vector-icon-for-ui-user-interface-or-profile-face-avatar-app-in-circle-design.jpg?s=612x612&w=0&k=20&c=1ky-gNHiS2iyLsUPQkxAtPBWH1BZt0PKBB1WBtxQJRE="
                                    : userProfile.startsWith("https") ? userProfile
                                        : `${SERVERURL}/imguploads/${userProfile}`} width={'50px'} height={'50px'} alt="" style={{ borderRadius: '50%' }} />
                        ...
                        <div className='relative inline-block text-left  '>
                            <button onClick={() => setDropdownStatus(!dropdownStatus)} className='w-full flex items-center px-3 py-2 shadow-lg hover:bg-gray-100 bg-white'>
                                <img src={userProfile == "" ? "https://media.istockphoto.com/id/1130884625/vector/user-member-vector-icon-for-ui-user-interface-or-profile-face-avatar-app-in-circle-design.jpg?s=612x612&w=0&k=20&c=1ky-gNHiS2iyLsUPQkxAtPBWH1BZt0PKBB1WBtxQJRE="
                                    : userProfile.startsWith("https") ? userProfile
                                        : `${SERVERURL}/imguploads/${userProfile}`} width={'50px'} height={'50px'} alt="" style={{ borderRadius: '50%' }} />
                                <p className='ms-2 text-gray-950'>{username}</p>
                            </button>
                            {dropdownStatus &&
                                <div className='absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-lg'>
                                    <Link to={'/profile'} className='block px-4 py-2 text-sm text-gray-700'>Profile</Link>
